...
//var classRegion01 = function (version_out, sufixName, versao_amostra, RFtrees) {
  ...
  for (var i_ano=0;i_ano<anos.length; i_ano++){
    var ano = anos[i_ano];
      ...
      var percent_Flo = -34.57 + 20 + ano * 0.01985
      var percent_Umi =  -2.06 + desvio + ano * 0.00125
      var percent_Cam = 416.10 + -5 + ano *-0.16821
      var percent_Agr =-236.11 + 15 + ano * 0.12384
      var percent_Anv = 12
  ...
  if (debug == 1){
    ...
    if (calcula_acuracia == 1){
      ...
      var acc = acura_region(classified85a20,ano_base,regiao,version_out,calcula_confusao);
    }
