...
//var classRegion01 = function (version_out, sufixName, versao_amostra, RFtrees) {
  ...
  var exporta_colecao = 2//ativar a geometria do bioma antes de dar o Run
  //*************************************
  ...
  //    Map.addLayer(SS_Flo_samples,{color:'ff0000'},'selecao')
   ...
   var training = SS_amostras//.merge(complementares)
    ...
    if(debug == 1){
      ...
      Map.addLayer(col_compara, vis, 'Colecao 6 v1 - ' + ano, false)
  ...
  if (debug == 1){
    ...
    var img_dif = diferenca(img_antes,img_depois,classe)
