...
var version_out = '06' // mudar a cada nova versao que for exportada
...
var ano_compara = 2022
// Define as classes a serem comparadas
var classes_list = [3, 11, 12, 21, 22, 33]
...
var allAreas_s2 = ee.FeatureCollection(areasByYear_s2)
  .flatten()
  .map(function(ft){
...
var createComparisonChart = function(classNumber) {
    ...
    var filteredFeatures2 = colls_area
      ...
      .filter(ee.Filter.eq('col', 'Col9_CF'))
...
for (var i_classe=0;i_classe<classes_list.length; i_classe++){
  ...
  var img_dif = diferenca(col9, class_atual, classe)
