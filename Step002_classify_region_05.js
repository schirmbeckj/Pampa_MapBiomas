...
var classe_diferenca = 33 // classe para mapa de diferenças
...
//Bloca 1A
 if (ano <= 1987){ // ajustar para período 1
    var percent_Flo = -34.30	   + 15 + ano *  0.01964
//    var percent_Umi = -13.51	   + desvio + ano *  0.00775
    var percent_Umi = 10
    var percent_Cam = 480.44	   + 7 + ano * -0.22508
    var percent_Agr =-293.47	   + 2 + ano *  0.17552
...
//Bloco 1B 
  if (ano > 1987 && ano <= 1992){// ajustar para período 2
    var percent_Flo = -34.30	   + 8 + ano *  0.01964
//    var percent_Umi = -13.51	   + desvio + ano *  0.00775
    var percent_Umi = 6
    var percent_Cam = 480.44	   + -5 + ano * -0.22508
    var percent_Agr =-293.47	   + 2 + ano *  0.17552
    var percent_Anv =  -3.04	   + desvio + ano *  0.00182
//    var percent_Afr =   0.00671  + desvio + ano *  0.00000
//    var percent_Agu = -36.14	   + desvio + ano *  0.02037
...
//    var percent_Umi = -13.51	   + desvio + ano *  0.00775
    var percent_Umi = 9
    var percent_Cam = 480.44	   + 1 + ano * -0.22508
    var percent_Agr =-293.47	   + 2 + ano *  0.17552
    var percent_Anv =  -3.04	   + desvio + ano *  0.00182
//    var percent_Afr =   0.00671  + desvio + ano *  0.00000
//    var percent_Agu = -36.14	   + desvio + ano *  0.02037
...
//    var percent_Umi = -13.51	   + desvio + ano *  0.00775
    var percent_Umi = 9
    var percent_Cam = 480.44	   + 4 + ano * -0.22508
    var percent_Agr =-293.47	   + -1 + ano *  0.17552
    var percent_Anv =  -3.04	   + desvio + ano *  0.00182
//    var percent_Afr =   0.00671  + desvio + ano *  0.00000
//    var percent_Agu = -36.14	   + desvio + ano *  0.02037
    var percent_Agu = 35
...
//    var percent_Umi = -13.51	   + desvio + ano *  0.00775
    var percent_Umi = 9
    var percent_Cam = 480.44	   + 6 + ano * -0.22508
    var percent_Agr =-293.47	   + -1 + ano *  0.17552
    var percent_Anv =  -3.04	   + desvio + ano *  0.00182
//    var percent_Afr =   0.00671  + desvio + ano *  0.00000
//    var percent_Agu = -36.14	   + desvio + ano *  0.02037
...
//    var percent_Umi = -13.51	   + desvio + ano *  0.00775
    var percent_Umi = 9
    var percent_Cam = 480.44	   + -2 + ano * -0.22508
    var percent_Agr =-293.47	   + 2 + ano *  0.17552
    var percent_Anv =  -3.04	   + desvio + ano *  0.00182
//    var percent_Afr =   0.00671  + desvio + ano *  0.00000
//    var percent_Agu = -36.14	   + desvio + ano *  0.02037
 ...
 //Bloco 2B
  if (ano > 2008 && ano <= 2012){// ajustar para período 2
    var percent_Flo = -34.30	   + 17 + ano *  0.01964
//    var percent_Umi = -13.51	   + desvio + ano *  0.00775
    var percent_Umi = 9
    var percent_Cam = 480.44	   + -3 + ano * -0.22508
    var percent_Agr =-293.47	   + 2 + ano *  0.17552
    var percent_Anv =  -3.04	   + desvio + ano *  0.00182
//    var percent_Afr =   0.00671  + desvio + ano *  0.00000
//    var percent_Agu = -36.14	   + desvio + ano *  0.02037
...
//    var percent_Umi = -13.51	   + desvio + ano *  0.00775
    var percent_Umi = 14
    var percent_Cam = 480.44	   + -4 + ano * -0.22508
    var percent_Agr =-293.47	   + 5 + ano *  0.17552
    var percent_Anv =  -3.04	   + desvio + ano *  0.00182
//    var percent_Afr =   0.00671  + desvio + ano *  0.00000
//    var percent_Agu = -36.14	   + desvio + ano *  0.02037
    var percent_Agu = 35
