...
//Bloco 1Aa
  if (ano <= 1987){ // ajustar para período 1
    var percent_Flo =  -60.14	    + 22 + ano *  0.03597
//    var percent_Umi =   -7.63	    + desvio + ano *  0.00400
    var percent_Umi = 11
//    var percent_Cam = 50
    var percent_Cam = 1245.50	    + 3 + ano * -0.60527
    var percent_Agr =-1069.87	    + 5 + ano *  0.56000
    //var percent_Anv =    4.00	    + desvio + ano * -0.00128
    var percent_Anv = 4 //   var percent_Afr =    0.00000	+ desvio + ano *  0.00000
...
//    var percent_Agu =  -11.87	    + desvio + ano *  0.00659
 ...
 //Bloco 1B
  if (ano > 1992 && ano <= 1998){// ajustar para período 2
    var percent_Flo =  -60.14	    + 15 + ano *  0.03597
    var percent_Umi = 10
//    var percent_Umi =   -7.63	    + desvio + ano *  0.00400
//    var percent_Cam = 50
    var percent_Cam = 1245.50	    + 3 + ano * -0.60527
//    var percent_Agr =-1069.87	    + 0 + ano *  0.56000
    var percent_Agr =-1069.87	    + 5 + ano *  0.56000
    var percent_Anv = 11
   //var percent_Anv =    4.00	    + desvio + ano * -0.00128
 //   var percent_Afr =    0.00000	+ desvio + ano *  0.00000
...
//    var percent_Agr =-1069.87	    + -6 + ano *  0.56000
    var percent_Agr = 57
    var percent_Anv = 7
//    var percent_Anv =    4.00	    + desvio + ano * -0.00128
//    var percent_Afr =    0.00000	+ desvio + ano *  0.00000
//    var percent_Agu =  -11.87	    + desvio + ano *  0.00659
 ...
 //bloco 3Ab
  if (ano > 2017 && ano <= 2021){// ajustar para período 2
    var percent_Flo =  -60.14	    + 22 + ano *  0.03597
    var percent_Umi = 10
//    var percent_Umi =   -7.63	    + desvio + ano *  0.00400
    var percent_Cam = 37
