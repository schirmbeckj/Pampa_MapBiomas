...
var version_out = '10'//mudar a cada nova versao que for exportada
...
//bloco1Aa
if (ano <= 1986){ // ajustar para período 1
    var percent_Flo = -67.15    + desvio + ano *  0.03533
    var percent_Umi =   8.23	  + -2 + ano * -0.00086
 // var percent_Umi = 5
    var percent_Cam =-168.52    + 4 + ano *  0.09066
    var percent_Agr = 230.34    + 2 + ano * -0.09970
    var percent_Anv = 12
//  var percent_Anv =  58.27	  + desvio + ano * -0.02647
//  var percent_Afr =   0.00000 + desvio + ano *  0.00000
    var percent_Agu =  38.84	  + 6 + ano *  0.00103
 }
  //bloco 1Ab
 if (ano > 1986 && ano <= 1989){ // ajustar para período 1 //CUIDADO data alterada na col9!!
     var percent_Flo = -67.15    + 2 + ano *  0.03533
...
//  var percent_Afr =   0.00000 + desvio + ano *  0.00000
 ...
 //bloco 1B
 if (ano > 1989 && ano <= 1993){ // ajustar para período 1 //CUIDADO data alterada na col9!!
    var percent_Flo = -67.15    + 10 + ano *  0.03533
    var percent_Umi =   8.23	  + desvio + ano * -0.00086
 // var percent_Umi = 5
    var percent_Cam =-168.52    + 7 + ano *  0.09066
    var percent_Agr = 230.34    + -1 + ano * -0.09970
    var percent_Anv = 12
//  var percent_Anv =  58.27	  + desvio + ano * -0.02647
//  var percent_Afr =   0.00000 + desvio + ano *  0.00000
    var percent_Agu =  38.84	  + 6 + ano *  0.00103
 ...
 //bloco 1C
  if (ano > 1993 && ano <= 1998){// ajustar para período 2//CUIDADO data alterada na col9!!
    var percent_Flo = -67.15    + 14 + ano *  0.03533
    var percent_Umi =   8.23	  + desvio + ano * -0.00086
    var percent_Cam =-168.52    + 5 + ano *  0.09066
    var percent_Agr = 230.34    + 0 + ano * -0.09970
    var percent_Anv = 10
//    var percent_Anv =  58.27	  + desvio + ano * -0.02647
 //   var percent_Afr =   0.00000 + desvio + ano *  0.00000
    var percent_Agu =  38.84	  + 6 + ano *  0.00103
  ...
  if (ano > 1998 && ano <= 2002){// ajustar para período 2//CUIDADO data alterada na col9!!
    var percent_Flo = -67.15    + 14 + ano *  0.03533
    var percent_Umi =   8.23	  + desvio + ano * -0.00086
    var percent_Cam =-168.52    + 2 + ano *  0.09066
    var percent_Agr = 230.34    + 4 + ano * -0.09970
var percent_Anv = 10
//    var percent_Anv =  58.27	  + desvio + ano * -0.02647
 //   var percent_Afr =   0.00000 + desvio + ano *  0.00000
var percent_Agu =  38.84	  + 6 + ano *  0.00103
 ...
 //bloco 2 Ba1
  if (ano > 2002 && ano <= 2006){// ajustar para período 2
     var percent_Flo = -67.15    + 18 + ano *  0.03533
    var percent_Umi =   8.23	  + desvio + ano * -0.00086
    var percent_Cam =-168.52    + 6 + ano *  0.09066
    var percent_Agr = 230.34    + 8 + ano * -0.09970
var percent_Anv = 10
//    var percent_Anv =  58.27	  + desvio + ano * -0.02647
 //   var percent_Afr =   0.00000 + desvio + ano *  0.00000
var percent_Agu =  38.84	  + desvio + ano *  0.00103
  ...
  if (ano > 2006 && ano <= 2010){// ajustar para período 2
     var percent_Flo = -67.15    + 18 + ano *  0.03533
    var percent_Umi =   8.23	  + desvio + ano * -0.00086
    var percent_Cam =-168.52    + -3 + ano *  0.09066
    var percent_Agr = 230.34    + 10 + ano * -0.09970
var percent_Anv = 10
//    var percent_Anv =  58.27	  + desvio + ano * -0.02647
 //   var percent_Afr =   0.00000 + desvio + ano *  0.00000
var percent_Agu =  38.84	  + desvio + ano *  0.00103
  ...
  if (ano > 2010 && ano <= 2012){// ajustar para período 2
     var percent_Flo = -67.15    + 18 + ano *  0.03533
    var percent_Umi =   8.23	  + desvio + ano * -0.00086
    var percent_Cam =-168.52    + -1 + ano *  0.09066
    var percent_Agr = 230.34    + 10 + ano * -0.09970
var percent_Anv = 10
//    var percent_Anv =  58.27	  + desvio + ano * -0.02647
 //   var percent_Afr =   0.00000 + desvio + ano *  0.00000
var percent_Agu =  38.84	  + desvio + ano *  0.00103
  ...
  if (ano > 2012 && ano <= 2022){ // ajustar para período 3
    ...
    var percent_Umi =   8.23	  + 4 + ano * -0.00086
    var percent_Cam =-168.52    + -1  + ano *  0.09066
    var percent_Agr = 230.34    + 10 + ano * -0.09970
    var percent_Anv = 10
//    var percent_Anv =  58.27	  + desvio + ano * -0.02647
//    var percent_Afr =   0.00000 + desvio + ano *  0.00000
  ...
  if (ano > 2022){ // ajustar para período 3
    ...
    // var percent_Cam =-168.52    + -4  + ano *  0.09066
    var percent_Cam = 17
    // var percent_Agr = 230.34    + 11 + ano * -0.09970
    var percent_Agr = 37
    var percent_Anv = 10
//    var percent_Anv =  58.27	  + desvio + ano * -0.02647
//    var percent_Afr =   0.00000 + desvio + ano *  0.00000
...
var prob_name = 'projects/mapbiomas-workspace/AMOSTRAS/col' + collection_out 
+ '/PAMPA/class_col_' + collection_out + '_prob' + 
'0'+ regiao + '_' + 'RF_PROB_col' + collection_out + '_v' + version_out        
