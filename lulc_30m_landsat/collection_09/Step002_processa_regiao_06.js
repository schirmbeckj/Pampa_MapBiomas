...
//bloco 1A
 ...
 // var percent_Umi = -18.67	  + desvio + ano *  0.00977
    var percent_Cam = 1047.10	  + -16+ ano * -0.49695
    var percent_Umi = 7
//  var percent_Cam = 25
    var percent_Agr =-739.03    + 14 + ano *  0.38306
    var percent_Anv = 12
...
//bloco 1Bb
 if (ano > 1994 && ano <= 1998){// ajustar para período 2
   var percent_Flo = -160.94    + 4 + ano *  0.08710
 // var percent_Umi = -18.67	  + desvio + ano *  0.00977
    var percent_Cam = 1047.10	  + -20 + ano * -0.49695
    var percent_Umi = 5
//  var percent_Cam = 25
    var percent_Agr =-739.03    + 13 + ano *  0.38306
    var percent_Anv = 18
//  var percent_Anv = -16.71 	  + desvio + ano *  0.00932
//  var percent_Afr =   0.04177 + desvio + ano * -0.00002
//  var percent_Agu = -11.74	  + desvio + ano *  0.00770
...
//    var percent_Flo =-160.94    + 0 + ano *  0.08710
    var percent_Flo = 8
    var percent_Umi = 3
//  var percent_Umi = -18.67	  + desvio + ano *  0.00977
    var percent_Cam =1047.10	  + -14 + ano * -0.49695
//  var percent_Cam = 20
    var percent_Agr =-739.03    + 6 + ano *  0.38306
    var percent_Anv = 10
//  var percent_Anv = -16.71 	  + desvio + ano *  0.00932
//  var percent_Afr =   0.04177 + desvio + ano * -0.00002
   // var percent_Agu = -11.74	  + desvio + ano *  0.00770
