...
{
    var anos = [1985,1991,2002,2017,2019]
...
for (var i_ano=0;i_ano<anos.length; i_ano++){
  var ano = anos[i_ano];
//bloco1A
if (ano <= 1989){ // ajustar para período 1
...
//  var percent_Afr =   0.00000 + desvio + ano *  0.00000
 ...
 //bloco 1B
 if (ano > 1989 && ano <= 1994){ // ajustar para período 1
    var percent_Flo = -67.15    + 10 + ano *  0.03533
    var percent_Umi =   8.23	  + desvio + ano * -0.00086
 // var percent_Umi = 5
...
// agrega a classificacao random forest nova com a classificacao estável das col anteriores
    Map.addLayer(classified.blend(img.select('mode').mask(estabilidadeMask)), vis, 'Blend' + ano,false)
